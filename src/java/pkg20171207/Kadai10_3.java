...
@WebServlet(urlPatterns = {"/pkg20171207/Kadai10_3"})
public class Kadai10_3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //SQL文の発行
            String id = request.getParameter("te");
            String text = request.getParameter("te2");
            String iine = request.getParameter("te3");
            ...
            String sql2="select * from T_TWEET";
